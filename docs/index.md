...
> [!tip] GitHub users
<<<<<<< HEAD
> You can also use the **[GitHub template](https://github.com/jackyzha0/quartz/generate)** to create your repository in one click, then clone that instead. See [[docs/getting-started/installation#Option A Use the GitHub Template Recommended|Option A]] in the installation guide.
=======
...
<<<<<<< HEAD
- **[[docs/getting-started/installation|Push to GitHub]]** with `npx quartz sync`
=======
